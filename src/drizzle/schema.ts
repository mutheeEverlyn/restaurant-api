...
export type tiAddress=typeof tableAddress.$inferInsert;
export type tiCategory=typeof tableCategory.$inferInsert;
export type tiComment=typeof tableComment.$inferInsert;
export type tiDriver=typeof tableDriver.$inferInsert;
export type tiMenuItem=typeof tableMenuItem.$inferInsert;
export type tiOrderMenuItem=typeof tableOrderMenuItem.$inferInsert;
export type tiOrder=typeof tableOrders.$inferInsert;
export type tiRestaurant=typeof tableRestaurant.$inferInsert;
export type tiRestaurantOwner=typeof tableRestaurantOwner.$inferInsert;
export type tiStatusCatalog=typeof tableStatusCatalog.$inferInsert
export type tiUsers=typeof tableUsers.$inferInsert;
export type tiOrderStatus=typeof tableOrderStatus.$inferInsert;
export type tsAddress=typeof tableAddress.$inferSelect;
export type tsCategory=typeof tableCategory.$inferSelect;
export type tsComment=typeof tableComment.$inferSelect;
export type tsDriver=typeof tableDriver.$inferSelect;
export type tsMenuItem=typeof tableMenuItem.$inferSelect;
export type tsOrderMenuItem=typeof tableOrderMenuItem.$inferSelect;
export type tsOrder=typeof tableOrders.$inferSelect;
export type tsRestaurant=typeof tableRestaurant.$inferSelect;
export type tsRestaurantOwner=typeof tableRestaurantOwner.$inferSelect;
export type tsStatusCatalog=typeof tableStatusCatalog.$inferSelect;
export type tsUsers=typeof tableUsers.$inferSelect;
export type tsOrderStatus=typeof tableOrderStatus.$inferSelect;
