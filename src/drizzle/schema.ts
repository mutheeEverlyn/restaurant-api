...
export type tiAddress=typeof tableState.$inferInsert;
export type tiCategory=typeof tableState.$inferInsert;
export type tiComment=typeof tableState.$inferInsert;
export type tiDriver=typeof tableState.$inferInsert;
export type tiMenuItem=typeof tableState.$inferInsert;
export type tiOrderMenuItem=typeof tableState.$inferInsert;
export type tiOrder=typeof tableState.$inferInsert;
export type tiRestaurant=typeof tableState.$inferInsert;
export type tiRestaurantOwner=typeof tableState.$inferInsert;
export type tiStatusCatalog=typeof tableState.$inferInsert;
export type tiUsers=typeof tableState.$inferInsert;
export type tiOrderStatus=typeof tableState.$inferInsert;
export type tsAddress=typeof tableState.$inferSelect;
export type tsCategory=typeof tableState.$inferSelect;
export type tsComment=typeof tableState.$inferSelect;
export type tsDriver=typeof tableState.$inferSelect;
export type tsMenuItem=typeof tableState.$inferSelect;
export type tsOrderMenuItem=typeof tableState.$inferSelect;
export type tsOrder=typeof tableState.$inferSelect;
export type tsRestaurant=typeof tableState.$inferSelect;
export type tsRestaurantOwner=typeof tableState.$inferSelect;
export type tsStatusCatalog=typeof tableState.$inferSelect;
export type tsUsers=typeof tableState.$inferSelect;
export type tsOrderStatus=typeof tableState.$inferSelect;
